/*
    ...
    !! auto detects if index buffer is GLushort or GLuint.
...
int main(int argc, char** argv)
{
    ...
    while(fgets(line, 256, f) != NULL)
    {
        ...
        if(mode == 1)
        {
            ...
            else if((mode2 == 0 || mode2 == 2) && sscanf(line, "%f %f %f %f %f %f %f", &vx, &vy, &vz, &r, &g, &b, &nx) == 7)
            {
                char add[256];
                sprintf(add, "%g,%g,%g,", vx, vy, vz);
                strcat(vertex_array, add);
            ...
            else if((mode2 == 0 || mode2 == 3) && sscanf(line, "%f %f %f %f %f %f", &vx, &vy, &vz, &nx, &ny, &nz) == 6)
            {
                char add[256];
                sprintf(add, "%g,%g,%g,", vx, vy, vz);
                strcat(vertex_array, add);
            ...
            else if((mode2 == 0 || mode2 == 4) && sscanf(line, "%f %f %f", &vx, &vy, &vz) == 3)
            {
